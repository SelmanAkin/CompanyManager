...
class LeavesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leafe" do
    assert_difference("Leave.count") do
      post leaves_url, params: { leafe: { employee_id: @leafe.employee_id, end_date: @leafe.end_date, start_date: @leafe.start_date, status: @leafe.status } }
    end
  ...
  test "should update leafe" do
    patch leafe_url(@leafe), params: { leafe: { employee_id: @leafe.employee_id, end_date: @leafe.end_date, start_date: @leafe.start_date, status: @leafe.status } }
